          ...
          <article className="lg:col-span-2 prose-legal">
            ...
            <div className="not-prose grid sm:grid-cols-2 gap-3 mb-6">
              {[
                ...
                { label: 'Cryptocurrency & Bitcoin SIPP Claims', href: '/mis-sold-sipp-claims/cryptocurrency-bitcoin-pension-investment/', desc: 'FCA-unregulated crypto assets in pension funds.' },
              ].map(item => (
